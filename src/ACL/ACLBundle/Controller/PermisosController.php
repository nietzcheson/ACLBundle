...
use ACL\ACLBundle\Entity\Permisos;
use ACL\ACLBundle\Form\PermisosType;
...
class PermisosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ACLBundle:Permisos')->findAll();

        return $this->render('ACLBundle:Permisos:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('permisos_show', array('id' => $entity->getId())));
        }

        return $this->render('ACLBundle:Permisos:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ACLBundle:Permisos')->find($id);
        ...
        return $this->render('ACLBundle:Permisos:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ACLBundle:Permisos:edit.html.twig', array(
            'entity'      => $entity,
